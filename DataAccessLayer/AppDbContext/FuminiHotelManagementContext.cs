...
public partial class FuminiHotelManagementContext : DbContext, IFuminiHotelManagementContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A14740EACE827C").IsUnique();
